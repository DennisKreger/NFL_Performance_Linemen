...
class barplot(object):
    ...
    * value_column: numerical value
    ...
    def plot(self, title: str = None, orientation: str = 'horizontal', initial_frame = 'min', value_label: str = None, item_label: str = None, time_label: str = 'Frame: ', frame_duration: int = 500, date_format: str = None):
        '''
    ...
    def __make_frames(self, title: str, frame_duration: int):
        '''
        bar_race.make_frames automatically makes frame from the earliest to the latest available time stamp
        '''
